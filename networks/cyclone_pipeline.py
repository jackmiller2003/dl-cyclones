...
if __name__ == '__main__':
    ...
    training_loader_uv = torch.utils.data.DataLoader(train_dataset_uv, target_parameters=[0,1], batch_size=10, shuffle=False, num_workers=2, drop_last=True)
    validation_loader_uv = torch.utils.data.DataLoader(validate_dataset_uv, target_parameters=[0,1], batch_size=10, shuffle=False, num_workers=2, drop_last=True)

    training_loader_z = torch.utils.data.DataLoader(train_dataset_z, batch_size=10, shuffle=False, num_workers=2, drop_last=True)
    validation_loader_z = torch.utils.data.DataLoader(validate_dataset_z, batch_size=10, shuffle=False, num_workers=2, drop_last=True)
